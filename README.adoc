...
ifndef::cloud-hosted[]
Open another command-line session and navigate back to the `start` directory to continue. Alternatively, you can open the project in your editor and navigate to the `start` directory from there.
endif::[]
