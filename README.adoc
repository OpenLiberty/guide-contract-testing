...
Refresh the pact broker URL at http://localhost:9292/[^] to verify that there is a new entry. Note there is no
...
You can also see the interactions URL at http://localhost:9292/pacts/provider/System/consumer/Inventory/latest[^] for more insights about each interaction.
